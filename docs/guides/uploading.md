...
**News & Updates** below the upload form highlights recent changes and announcements, with dates and a link to the full changelog. Maintainers update the newest-first highlights in `components/upload/NewsUpdates.tsx` from shipped entries in `CHANGELOG.md`.
