...
This login does not make interrupted uploads resumable or turn process-local admission into a distributed queue. The existing [durable-upload decision](../adr/0004-durable-upload-boundary.md) remains separate, with no extra infrastructure cost authorized.
