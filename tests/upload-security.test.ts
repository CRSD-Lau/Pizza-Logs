...
assert.equal(MAX_UPLOAD_BYTES, 1024 ** 3);
assert.equal(parseUploadSize(String(101 * 1024 * 1024), "fileSize"), 101 * 1024 * 1024);
...
assert.equal(parserHttpErrorMessage(413), "File exceeds the 1 GiB upload limit.");
